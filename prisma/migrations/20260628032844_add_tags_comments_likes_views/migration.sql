...
-- CreateIndex
CREATE UNIQUE INDEX "Like_postId_adminId_key" ON "Like"("postId", "adminId");
...
-- AddForeignKey
ALTER TABLE "Like" ADD CONSTRAINT "Like_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "Admin"("id") ON DELETE CASCADE ON UPDATE CASCADE;
